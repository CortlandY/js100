...
/* I got this one wrong initially. Declaring the let variable a on line 6 interferes with the declaration on line 2. 
since let variables cannot be called until they are declared, this creates an error message. 
...
JavaScript does hoist the variables defined by let, but, when it does, it creates a "temporal dead zone" 
in which the variable exists but doesn't have a value -- not even a value of undefined. 
